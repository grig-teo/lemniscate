/**
 * AGENTS.md-per-folder section of the library-attachment editor (extracted
 * from LibraryAttachments.tsx per AGENTS.md section 2): one row per folder
 * with a template picker or file upload, plus the repository folder browser.
 */
...
import { useRepoFolders, useSkillLibrary } from '@/lib/library';
